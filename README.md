PanopticStudio Tools
======================

This repo contains toolbox to download, extract and visualize and process the [Panoptic Studio](http://domedb.perception.cs.cmu.edu) (Panoptic) data.
...
```
git clone https://github.com/leehsiu/PanopticStudioTools
```
